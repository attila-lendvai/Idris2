...
BOOTSTRAP_IDRIS=$PREFIX/bin/idris2
...
$MAKE libs BOOTSTRAP_IDRIS=${BOOTSTRAP_IDRIS} IDRIS2_CG="$IDRIS2_CG" LD_LIBRARY_PATH="$DYLIB_PATH" \
    PREFIX="$PREFIX" SCHEME="$SCHEME"
$MAKE install IDRIS2_CG="$IDRIS2_CG" LD_LIBRARY_PATH="$DYLIB_PATH" \
    PREFIX="$PREFIX" SCHEME="$SCHEME"

# Now rebuild everything properly
$MAKE clean-libs BOOTSTRAP_IDRIS="${BOOTSTRAP_IDRIS}"
$MAKE all BOOTSTRAP_IDRIS="${BOOTSTRAP_IDRIS}" IDRIS2_CG="$IDRIS2_CG" \

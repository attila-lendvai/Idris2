...
# FIXME deleting $(BUILD)/bootstrap-host/ttc/IdrisPath.ttc shouldn't be necessary; see bug: https://github.com/idris-lang/Idris2/issues/2033
$(IDRIS_PATHS_FILE): FORCE
	...
	@if ! cmp -s $(IDRIS_PATHS_FILE) $(IDRIS_PATHS_FILE).new; then \
	  ...
	  echo "Updated $(IDRIS_PATHS_FILE)"; \
          $(RM) $(BUILD)/bootstrap-host/ttc/IdrisPath.*; \
	else \
...
# These rules could live next to each other, but I don't know how to
# tell make's rule engine which path to chose when generating the
# exe; hence the conditional definition.

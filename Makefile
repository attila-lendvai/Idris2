...
ifeq ($(OS), darwin)
	sed -i '' 's|__PREFIX__|${BOOTSTRAP_IDRIS_PREFIX}/|g' bootstrap/idris2_app/idris2-boot.ss
else
	sed -i 's|__PREFIX__|${BOOTSTRAP_IDRIS_PREFIX}/|g' bootstrap/idris2_app/idris2-boot.ss
endif
...
ifeq ($(OS), darwin)
	sed -i '' 's|__PREFIX__|${BOOTSTRAP_IDRIS_PREFIX}/|g' bootstrap/idris2_app/idris2-boot.rkt
else
	sed -i 's|__PREFIX__|${BOOTSTRAP_IDRIS_PREFIX}/|g' bootstrap/idris2_app/idris2-boot.rkt
endif
